...
resourcename="pruebas1iter16"  # lower case, only
resourcegroup="pruebas1iter16_rg"
...
# git clone https://github.com/apilogicserver/pruebas1iter16.git
# cd pruebas1iter16
...
az group create --name pruebas1iter16_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group pruebas1iter16_rg --sku S1 --is-linux
az container create --resource-group pruebas1iter16_rg --name pruebas1iter16 --image apilogicserver/pruebas1iter16:latest --dns-name-label pruebas1iter16 --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//pruebas1iter16.westus.azurecontainer.io:5656'
