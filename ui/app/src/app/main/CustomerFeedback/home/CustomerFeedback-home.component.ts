...
@Component({
  selector: 'CustomerFeedback-home',
  templateUrl: './CustomerFeedback-home.component.html',
  styleUrls: ['./CustomerFeedback-home.component.scss']
})
export class CustomerFeedbackHomeComponent implements AfterViewInit {
